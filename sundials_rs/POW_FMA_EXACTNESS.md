...
| Bit-exact with the reference libm across all doubles? | **Yes as far as measured** — 0 mismatches over 20M unrestricted inputs against a glibc `pow`, measured both natively on Windows (§0) and natively on Linux (§0.1). Against the arm64-built oracles of §§1–7, 2 inputs in 20M differed by 1 ulp. |
